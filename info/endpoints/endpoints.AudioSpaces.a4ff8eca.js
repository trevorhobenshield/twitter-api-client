(self.webpackChunk_twitter_responsive_web =
  ...
  ["endpoints.AudioSpaces"],
  {
    64332: (e) => {
      e.exports = {
        queryId: "I-a0aEU_NFrl-zpeR0GeSg",
    ...
    27260: (e, t, r) => {
      ...
      function p(e) {
        ...
        const { rest_id: b, state: f } = n;
        a()(b, "rest_id is required"), a()(f, "state is required");
        const y = (function (e) {
      ...
      const I = ({ apiClient: e, featureSwitches: t }) => ({
          ...
          subscribeToScheduledSpaceById(t) {
            ...
            return e.graphQL(g(), { id: t }, B(r, t)).catch(x(r)).then(A(r));
          },
          unsubscribeFromScheduledSpaceById(t) {
            const r = "unsubscribeFromScheduledSpaceById";
            return e.graphQL(q(), { id: t }, B(r, t)).catch(x(r)).then(A(r));
          },
          search(t, r) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/endpoints.AudioSpaces.a4ff8eca.js.map
