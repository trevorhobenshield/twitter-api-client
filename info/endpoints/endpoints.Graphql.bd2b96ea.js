    ...
    97534: (e, _, t) => {
      ...
      t.r(_),
        t.d(_, {
          ...
          isFatalViewerScopedFollowTimelineError: () => R,
          parseUserScopedTimeline: () => C,
      ...
      const j = ({ apiClient: e, featureSwitches: _ }) => ({
        ...
        fetchViewerTeams: () =>
          e
            .graphQLFullResponse(P(), { ...(0, o.S)(_) }, E)
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/endpoints.Graphql.bd2b96ea.js.map
