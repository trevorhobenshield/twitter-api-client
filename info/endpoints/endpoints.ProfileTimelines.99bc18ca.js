(self.webpackChunk_twitter_responsive_web =
  ...
  ["endpoints.ProfileTimelines", "endpoints.Graphql"],
  {
    ...
    5568: (e) => {
      e.exports = {
        queryId: "dm7ReTFJoeU0qkiZCO1E1g",
    ...
    57767: (e) => {
      e.exports = {
        queryId: "dq1eUCn3N8v0BywlP4nT7A",
    ...
    70816: (e) => {
      e.exports = {
        queryId: "jF-OgMv-9vAym3JaCPUnhQ",
    ...
    11497: (e) => {
      e.exports = {
        queryId: "1by3q8-AJWdNYhtltjlPTQ",
    ...
    97534: (e, _, t) => {
      ...
      t.r(_),
        t.d(_, {
          ...
          isFatalModeratedTimelineError: () => Z,
          isFatalTeamsResponseError: () => E,
          isFatalUserScopedFollowTimelineError: () => N,
          isFatalViewerScopedFollowTimelineError: () => G,
          parseUserScopedTimeline: () => Q,
          parseViewerScopedTimeline: () => L,
        });
      var n = t(58955),
        i = t(79363),
        r = t(72599),
      ...
      const Q = (e) => {
        ...
        L = (e) => {
          ...
          null != e &&
            e.viewer &&
            (_ =
              (null == (t = e.viewer.timeline) ? void 0 : t.timeline) || Y.cY);
          return _;
        },
        E = (e) =>
          Array.isArray(e) &&
      ...
      const M = ({ apiClient: e, featureSwitches: _ }) => ({
        fetchBlockedAccountsImportedGraphql: j(a.kH.Imported, e, _),
        fetchBlockedAccountsAllGraphql: j(a.kH.All, e, _),
        fetchBlockedAccountsAutoBlockGraphql: j(a.kH.AutoBlock, e, _),
        ...
        fetchViewerTeams: () =>
          e
            .graphQLFullResponse(S(), { ...(0, s.S)(_) }, E)
        ...
        fetchGenericTimelineById: ({ count: t, cursor: n, timelineId: i }) =>
          e
            ...
            .then((e) => {
              var _;
              return (null == (_ = e.timeline) ? void 0 : _.timeline) || Y.cY;
            }),
      });
    },
    75948: (e, _, t) => {
      "use strict";
      t.r(_),
        t.d(_, { default: () => I, isFatalProfileTimelineError: () => k });
      var n = t(72599),
        i = t(51573),
        r = t(17360),
        a = t(83175),
      ...
      const k = (e, _) => {
        ...
        I = ({ apiClient: e, featureSwitches: _ }) => ({
                    ...
                    (t) =>
                      t
                        ...
                        : ((0, n.ZP)(
                          ...
                          _()),
                    () => ((s.q.prefetchPromiseRejected[e] = !0), _())
                  )
                  .finally(() => {
                    delete i.items[e];
                  }))
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/endpoints.ProfileTimelines.99bc18ca.js.map
