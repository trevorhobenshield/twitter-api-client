(self.webpackChunk_twitter_responsive_web =
  ...
  ["endpoints.AudioSpaces"],
  {
    78111: (e) => {
      e.exports = {
        queryId: "SZf3Ceycp2dG7rrjd4oorg",
    ...
    27260: (e, t, r) => {
      ...
      const L = ({ apiClient: e, featureSwitches: t }) => ({
        ...
        x = (e, t) => `GQL: AudioSpaces.${e} [${t}]`;
      function A(e) {
        return (t) => {
          if (t) throw new Error(x(e, t.message));
        };
      }
      function I(e) {
        return (t) => {
          if (t) return t;
          throw new Error(x(e, "404"));
        };
      }
      const C = (e, t) => !1;
      function Q(e, t, r = C) {
        return function (i, n) {
          ...
          if (i.length) {
            ...
            let u;
            const _ = k.find(({ matches: e }) => e(o));
            if (null != _ && _.message) u = x(e, _.message);
            else if (Array.isArray(l)) {
              const t = l.map(B).join(".");
              u = x(e, t);
            } else u = x(e, o || "isFatalError");
      ...
      const k = ["Overcapacity: Unspecified", "Timeout: Unspecified"].map(
        (e) => ({
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/endpoints.AudioSpaces.fb28a96a.js.map
