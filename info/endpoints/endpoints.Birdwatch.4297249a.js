(self.webpackChunk_twitter_responsive_web =
  ...
  ["endpoints.Birdwatch"],
  {
    ...
    74147: (e) => {
      e.exports = {
        queryId: "65b3OeRrj10wkV4sRZW1TQ",
    ...
    4095: (e) => {
      e.exports = {
        queryId: "uEbQ9JIKx303YJinMOYP4Q",
    ...
    46880: (e) => {
      e.exports = {
        queryId: "sRwauX_gbNhqkOooWXKwAA",
    ...
    10957: (e) => {
      e.exports = {
        queryId: "GFay_vg65_zQsQ-PTzBg1g",
    ...
    38389: (e) => {
      e.exports = {
        queryId: "EeBIx2v5a-_Th56kQxM7NQ",
    ...
    10695: (e, t, a) => {
      ...
      const V = { result: [], entities: {}, slice_info: {} },
        ...
        te = ({ apiClient: e, featureSwitches: t }) => ({
          acknowledgeEarnOut: () => e.graphQL(Y(), {}),
          ...
          deleteNote: (t) => e.graphQL(L(), { note_id: t.note_id }),
          deleteRating: (t) => e.graphQL(A(), { note_id: t.note_id }),
          editNotificationSettings: (t) =>
            e.graphQL(F(), { settings: t.settings }),
          fetchOneNote: (a) =>
          ...
          fetchNotes(a) {
            const { tweet_id: r } = a;
            return e.graphQL(Z(), { tweet_id: r, ...(0, o.S)(t) }).then((e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/endpoints.Birdwatch.4297249a.js.map
