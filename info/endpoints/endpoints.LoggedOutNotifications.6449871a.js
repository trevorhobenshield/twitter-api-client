  ...
  ["endpoints.LoggedOutNotifications", "endpoints.Graphql"],
  {
    ...
    97534: (e, t, _) => {
      ...
      const z = (e) => {
        ...
        C = (e) => {
          ...
          null != e &&
            e.viewer &&
            (t =
              (null == (_ = e.viewer.timeline) ? void 0 : _.timeline) || P.cY);
          return t;
        },
        N = (e) =>
          Array.isArray(e) &&
      ...
      const H = ({ apiClient: e, featureSwitches: t }) => ({
        fetchBlockedAccountsImportedGraphql: j(r.kH.Imported, e, t),
        fetchBlockedAccountsAllGraphql: j(r.kH.All, e, t),
        fetchBlockedAccountsAutoBlockGraphql: j(r.kH.AutoBlock, e, t),
        ...
        fetchViewerTeams: () =>
          e
            .graphQLFullResponse(L(), { ...(0, l.S)(t) }, N)
        ...
        fetchGenericTimelineById: ({ count: _, cursor: n, timelineId: i }) =>
          e
            ...
            .then((e) => {
              var t;
              return (null == (t = e.timeline) ? void 0 : t.timeline) || P.cY;
            }),
      });
    },
    54874: (e, t, _) => {
      ...
      _.r(t),
        _.d(t, {
          default: () => s,
          isEnableLoggedOutWebUsersNotificationsFail: () => l,
        });
      var n = _(72599),
        i = _(17360),
        a = _(72298),
        ...
        o = _(97534);
      const l = (e, t) => (
          (null == t ? void 0 : t.enable_logged_out_web_notifications) ||
            (0, n.ZP)(
              "GQL LoggedOutNotifications: Failed to execute EnableLoggedOutWebNotifications",
              { extra: (0, o.errorBreadcrumb)(e) }
            ),
          (0, i.jB)(e)
        ),
        s = ({ apiClient: e, featureSwitches: t }) => ({
          enableLoggedOutWebNotifications: (t) => e.graphQL(r(), t, l),
        });
    },
    83175: (e, t, _) => {
      "use strict";
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/endpoints.LoggedOutNotifications.6449871a.js.map
