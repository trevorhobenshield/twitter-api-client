  ...
  ["endpoints.Graphql"],
  {
    ...
    97534: (e, _, t) => {
      ...
      const Z = (e) => {
        ...
        N = (e) => {
          ...
          null != e &&
            e.viewer &&
            (_ =
              (null == (t = e.viewer.timeline) ? void 0 : t.timeline) || Q.cY);
          return _;
        },
        U = (e) =>
          Array.isArray(e) &&
      ...
      const M = ({ apiClient: e, featureSwitches: _ }) => ({
        fetchBlockedAccountsImportedGraphql: K(a.kH.Imported, e, _),
        fetchBlockedAccountsAllGraphql: K(a.kH.All, e, _),
        fetchBlockedAccountsAutoBlockGraphql: K(a.kH.AutoBlock, e, _),
        ...
        fetchViewerTeams: () =>
          e
            .graphQLFullResponse(P(), { ...(0, o.S)(_) }, U)
        ...
        fetchGenericTimelineById: ({ count: t, cursor: n, timelineId: i }) =>
          e
            ...
            .then((e) => {
              var _;
              return (null == (_ = e.timeline) ? void 0 : _.timeline) || Q.cY;
            }),
      });
    },
    49890: (e, _, t) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/endpoints.Graphql.28b7833a.js.map
